...
// Range to/from ::nucleus::genomics::v1::Range conversion

bool Clif_PyObjAs(PyObject* py, ::nucleus::genomics::v1::Range* c) {
  CHECK(c != nullptr);
  PyObject* type = ImportFQName("third_party.nucleus.protos.range_pb2.Range");
  if (!::clif::proto::TypeCheck(py, type, "", "Range") ) {
...
bool Clif_PyObjAs(PyObject* py, std::unique_ptr<::nucleus::genomics::v1::Range>* c) {
  CHECK(c != nullptr);
  if (!*c) c->reset(new ::nucleus::genomics::v1::Range);
  return Clif_PyObjAs(py, c->get());
}

PyObject* Clif_PyObjFrom(const ::nucleus::genomics::v1::Range& c, py::PostConv) {
  PyObject* type = ImportFQName("third_party.nucleus.protos.range_pb2.Range");
  return ::clif::proto::PyProtoFrom(&c, type, "");
}

PyObject* Clif_PyObjFrom(std::unique_ptr<const ::nucleus::genomics::v1::Range> c, py::PostConv) {
  if (!c) Py_RETURN_NONE;
  PyObject* type = ImportFQName("third_party.nucleus.protos.range_pb2.Range");
  return ::clif::proto::PyProtoFrom(c.get(), type, "");
}

PyObject* Clif_PyObjFrom(std::shared_ptr<const ::nucleus::genomics::v1::Range> c, py::PostConv) {
  if (!c) Py_RETURN_NONE;
  PyObject* type = ImportFQName("third_party.nucleus.protos.range_pb2.Range");
  return ::clif::proto::PyProtoFrom(c.get(), type, "");
}
